...
function printNavbar() {
    ...
    if (isset($_SESSION['user'])) {
        $usr_dropdown = file_get_contents("./templates/usr_dropdown.html");
        $navbar = str_replace('%usr_dropdown%', $usr_dropdown, $navbar);
        $usr_name = $_SESSION['user']['usr_firstname'] . " " . $_SESSION['user']['usr_lastname'];
        $navbar = str_replace('%usr_name%',$usr_name, $navbar);
    }

    $navbar = str_replace('%usr_dropdown%', '', $navbar);
    print $navbar;
}
